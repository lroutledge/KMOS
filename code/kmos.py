...
the image accross seevral frames.
...
os.chdir("/Data/routledge/KMOS/data/sept")    #directory containing the data
...
means_second = np.zeros(shape)
var_second = np.zeros(shape)
M2_second = np.zeros(shape)
...
##    plt.figure()
##    plt.imshow(data, cmap='gray', vmin=-20, vmax=25)
##    plt.title('After median subtration')
##    plt.colorbar()
##
